...
- The install command runs on a blocking worker thread so long winget/npm/system installer steps do not freeze the Tauri window or make Windows mark Profile Switcher as not responding.
...
3. Create and push a tag, for example `v0.1.20`.
